...
public class FrmFornecedor extends javax.swing.JFrame {
    ...
    private final Fornecedor pFornec = new Fornecedor();
    ...
    private void initComponents() {
        ...
        setTitle("Sys Vendas - Cadastro de Fornecedores");
        ...
        btnPesquisaFornecedor.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        btnPesquisaFornecedor.setText("Pesquisar");
    ...
    private void btnVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVoltarActionPerformed
        if (eNovo == true) {
            ...
            try {
                Fornecedor f = fController.buscaIdFornecedor(txtCodigo.getText());
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        try {
            if (eNovo == true) {
                fController.cadastrarFornecedor(txtNome.getText(), txtCelular.getText(), txtFixo.getText(), jcbPessoa.getSelectedItem().toString(),
                        txtCpfCnpj.getText(), txtRG.getText(), txtCEP.getText(), txtEndereco.getText(), txtNumero.getText(), txtCompl.getText(),
                        txtBairro.getText(), txtCidade.getText(), jcbEstado.getSelectedItem().toString(), txtEmail.getText(), txtObs.getText());
                
                JOptionPane.showMessageDialog(this, "Fornecedor cadastrado\nCom Sucesso!", "Fornecedores", JOptionPane.INFORMATION_MESSAGE);
                limpaCampos();
                fechaEdicao();
            } else {
                fController.atualizarFornecedor(txtCodigo.getText(), txtNome.getText(), txtCelular.getText(), txtFixo.getText(), jcbPessoa.getSelectedItem().toString(),
                        txtCpfCnpj.getText(), txtRG.getText(), txtCEP.getText(), txtEndereco.getText(), txtNumero.getText(), txtCompl.getText(),
                        txtBairro.getText(), txtCidade.getText(), jcbEstado.getSelectedItem().toString(), txtEmail.getText(), txtObs.getText());
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if (txtCodigo.getText().isEmpty() || txtNome.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Selecione um Fornecedor", "Fornecedores", JOptionPane.WARNING_MESSAGE);
        }
        try {
            Fornecedor f = fController.buscaCPFFornecedor(txtCpfCnpj.getText());
            txtCodigo.setText(Integer.toString(f.getId()));
            habilitaEdicao();
            eNovo = false;
        } catch (Exception e) {
    ...
    private void btnBuscarCodigoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarCodigoActionPerformed
        if (txtCodigo.getText() == null || txtCodigo.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Informe um código!", "Fornecedores", JOptionPane.WARNING_MESSAGE);
        }
        try {
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        try {
            fController.buscaIdFornecedor(txtCodigo.getText());
            int resp = JOptionPane.showConfirmDialog(null, "Confirma Exclusão do Fornecedor ?", "Exclusão", JOptionPane.YES_NO_OPTION);

            if (resp == JOptionPane.YES_OPTION) {
                fController.deletarFornecedor(txtCodigo.getText());
    ...
    private void btnBuscaCEPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscaCEPActionPerformed
        if (txtCEP.getText().length() < 9) {
            JOptionPane.showMessageDialog(null, "Informe o Cep completo para pesquisa");
        }
        try {
            Fornecedor f = fController.buscaCEPFornecedor(txtCEP.getText());
            txtEndereco.setText(f.getEndereco());
            txtBairro.setText(f.getBairro());
            txtCidade.setText(f.getCidade());
            jcbEstado.setSelectedItem(f.getEstado());
    ...
    private void btnPesquisaFornecedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisaFornecedorActionPerformed
        DlgGradeFornecedores gradeFornecedores = new DlgGradeFornecedores(this, true);
        gradeFornecedores.setVisible(true);
        String cod = gradeFornecedores.getCodigo();

        Fornecedor f = fController.buscaIdFornecedor(cod);
